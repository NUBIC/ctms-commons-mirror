...
/
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'person_and_organization_information_manager',	'Manages organizations and rosters / Creates and updates person info including contact info, degrees/certifications, rosters they?re associated with',		(select currval('csm_applicati_application__seq')))
/
...
/
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'study_team_administrator',	'Connects study level people to study and internal staff to study
/ Assigns internal staff to protocol, determines study artifact accessiblity for staff (e.g. study calendar templates, CRFs, etc.)',		(select currval('csm_applicati_application__seq')))
/
...
/
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'expedited_report_reviewer',	'Read-only: reviews, provides comments, and routes expedited reports through the review workflow',		(select currval('csm_applicati_application__seq')))
/
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'adverse_event_study_data_reviewer',	'Read-only: reviews, provides comments, and adverse event data through a review workflow',		(select currval('csm_applicati_application__seq')))
/
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'expedited_report_reviewer',	'Read-only: reviews, provides comments, and routes expedited reports through the review workflow',		(select currval('csm_applicati_application__seq')), 1)
/
INSERT INTO csm_privilege(privilege_id, privilege_name, privilege_description) VALUES ((select nextval('csm_privilege_privilege_id_seq')),	'expedited_report_reviewer',	'Read-only: reviews, provides comments, and routes expedited reports through the review workflow')
/
INSERT INTO csm_role_privilege(role_privilege_id, role_id, privilege_id) VALUES ((select nextval('csm_role_priv_role_privile_seq')),(select currval('csm_role_role_id_seq')),(select currval('csm_privilege_privilege_id_seq')))
/

INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'adverse_event_study_data_reviewer',	'Read-only: reviews, provides comments, and adverse event data through a review workflow',		(select currval('csm_applicati_application__seq')), 1)
/
INSERT INTO csm_privilege(privilege_id, privilege_name, privilege_description) VALUES ((select nextval('csm_privilege_privilege_id_seq')),	'adverse_event_study_data_reviewer',	'Read-only: reviews, provides comments, and adverse event data through a review workflow')
/
INSERT INTO csm_role_privilege(role_privilege_id, role_id, privilege_id) VALUES ((select nextval('csm_role_priv_role_privile_seq')),(select currval('csm_role_role_id_seq')),(select currval('csm_privilege_privilege_id_seq')))
/
...
update csm_group set update_date = (SELECT LOCALTIMESTAMP)
/
update csm_role set update_date = (SELECT LOCALTIMESTAMP)
/